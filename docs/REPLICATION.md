...
The designer lets you select a SOFA HRIR file, define noise types with azimuth/elevation orientations, and tune looming trajectory radius, path direction, path length, and propagation speed. Keep the resulting JSON with your protocol materials when running a non-default variant.
